...
public class Lesson1BinaryGapRepeat {
    /*
    ...
    two binary gaps: one of length 4 and one of length 3. The number 20 has binary representation 10100 and contains one binary gap of length 1. The number 15 has
    ...
    public int solution(int N) {
        ...
        for (int i=0; i< Integer.SIZE; i++) {
            ...
            if (bit) {
                if (curLength != null && curLength > res) {
                    res = curLength;
                }
                curLength = 0;
            } else if (curLength != null) {
                curLength++;
            }
//            System.out.printf("mask: %d, bit = %s, curLength=%d, res = %d\n", mask, bit, curLength, res);
